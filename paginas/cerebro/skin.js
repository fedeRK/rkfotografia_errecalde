...
// Filename: RK Anato3DnoStage.ggsk
// Generated vie. 25. mar. 14:34:27 2022
...
function object2vrSkin(player,base) {
	...
	this.addSkin=function() {
		...
		this._tt_zoomin.ggUpdatePosition=function() {
			...
			if (this.parentNode) {
				var w=this.parentNode.offsetWidth;
				this.style.left=Math.floor(-104 + w/2) + 'px';
				var h=this.parentNode.offsetHeight;
				this.style.top=Math.floor(-18 + h) + 'px';
			}
		}
		hs ='position:absolute;';
		hs+='left: -104px;';
		...
		this._container_2.appendChild(this._tt_zoomin);
		...
		this._tt_zoomout.ggUpdatePosition=function() {
			...
			if (this.parentNode) {
				var w=this.parentNode.offsetWidth;
				this.style.left=Math.floor(-75 + w/2) + 'px';
				var h=this.parentNode.offsetHeight;
				this.style.top=Math.floor(-18 + h) + 'px';
			}
		}
		...
		this._container_2.appendChild(this._tt_zoomout);
		...
		this._container_2.appendChild(this._tt_autorotate);
