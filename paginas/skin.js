...
// Generated jue. 24. mar. 20:18:56 2022
	...
	this.addSkin=function() {
		...
		this._up.ggUpdatePosition=function() {
			...
			if (this.parentNode) {
				...
				this.style.top=Math.floor(-75 + h) + 'px';
			}
		}
		...
		this._left.ggUpdatePosition=function() {
			...
			if (this.parentNode) {
				var w=this.parentNode.offsetWidth;
				this.style.left=Math.floor(-96 + w/2) + 'px';
				var h=this.parentNode.offsetHeight;
		...
		this._right.ggUpdatePosition=function() {
			...
			if (this.parentNode) {
				var w=this.parentNode.offsetWidth;
				this.style.left=Math.floor(-46 + w/2) + 'px';
				var h=this.parentNode.offsetHeight;
				this.style.top=Math.floor(-60 + h) + 'px';
			}
		}
		...
		this._zoomout.ggUpdatePosition=function() {
			...
			if (this.parentNode) {
				var w=this.parentNode.offsetWidth;
				this.style.left=Math.floor(24 + w/2) + 'px';
				var h=this.parentNode.offsetHeight;
				this.style.top=Math.floor(-60 + h) + 'px';
			}
		}
