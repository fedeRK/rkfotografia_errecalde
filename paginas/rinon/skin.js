...
// Generated vie. 25. mar. 18:28:35 2022
	...
	this.addSkin=function() {
		...
		this._tt_corazon.ggUpdatePosition=function() {
			...
			if (this.parentNode) {
				...
				this.style.left=Math.floor(-109 + w/2) + 'px';
		...
		this._tt_corazon.ggTextDiv.innerHTML="Ri\xf1on";
		...
		this._tt_confint.ggUpdatePosition=function() {
			...
			if (this.parentNode) {
				...
				var h=this.parentNode.offsetHeight;
				this.style.top=Math.floor(-34 + h) + 'px';
			}
		}
		hs ='position:absolute;';
		hs+='left: -115px;';
		...
		this._tt_confint.ggTextDiv.innerHTML="Irrigaci\xf3n";
